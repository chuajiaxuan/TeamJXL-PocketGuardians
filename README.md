...
3. FaceBook Page: Access it [here](https://www.facebook.com/PocketGuardians/?fref=ts)
3. APK(FOR ANDROID ONLY) [Link](https://github.com/chuajiaxuan/TeamJXL-PocketGuardians/releases/tag/v2.0-alpha)
